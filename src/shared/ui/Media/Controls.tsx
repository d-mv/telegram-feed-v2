...
import { SpeakerWaveIcon } from "../../../assets/SpeakerWaveIcon";
import { SpeakerXMarkIcon } from "../../../assets/SpeakerXMarkIcon";
  ...
  return (
    ...
    >
      ...
      <button type="button" style={btnStyle} onClick={handleToggleMute} disabled={!videoUrl} aria-label={getMuteLabel()}>
        {!isMuted ? (
          <SpeakerWaveIcon style={iconStyle} />
        ) : (
          <SpeakerXMarkIcon style={iconStyle} />
        )}
      </button>
    </div>
  );
