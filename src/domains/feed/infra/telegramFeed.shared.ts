...
export function getMediaGroupKey(message: Api.Message): string | undefined {
	const groupedId = (message as Api.Message & { groupedId?: unknown })
		.groupedId;
	if (
...
export function getPollPreview(
	message: Api.Message,
): FeedItem["poll"] | undefined {
