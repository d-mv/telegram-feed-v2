...
function renderWithProviders(
	...
	if (options.feedFilters)
		store.set(feedFilterSettingsAtom, options.feedFilters);
	if (options.notificationSettings)
		store.set(notificationSettingsAtom, options.notificationSettings);
	...
	return render(
		<Provider store={store}>
			<AppContext.Provider
				value={contextValue(options.contextOverrides) as never}
			>
				{ui}
			</AppContext.Provider>
		</Provider>,
