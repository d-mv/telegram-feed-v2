...
export function isFeedFilterSettings(value: unknown): value is FeedFilterSettings {
  if (!value || typeof value !== "object") {
    return false;
  }
  return Object.values(value).every((entry) => typeof entry === "boolean");
...
export function isAvatarVisibilitySettings(value: unknown): value is AvatarVisibilitySettings {
  if (!value || typeof value !== "object") {
    return false;
  }
